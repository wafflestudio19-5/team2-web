...
const dummyData=[
  {
    ...
    images:['http://www.dailygaewon.com/news/photo/201906/4510_5372_5434.JPG',
  ...
  },
  {
    ...
    id:'JingBurger',
    time: '3min',
    profileImg: 'https://w.namu.la/s/ec5be7fbad71fb5dfc41fb21f5eae44f43ab629b0a5f8629d0c57f56a64ea35bdff4fe23ad35ff158fff1e672efc44565ee9ac9195050491411b0a982a8dea985e9bb3d80a1c93e0e99af626eaa3f3e793d111c28106a94cc96dcbd44459a638',
    text: '안녕하세요~ 징~버거입니다~',
    images:['https://w.namu.la/s/82db436174608ea71ccd15413a8307e01043e361ec2255cd7589aa736321cd49c3908d06726749612d942c807b265ee737013cf6ecbe722063695a84507acc93d8fd48a04f61eeda3d13d039dd38ec134259c039ca2872e7f5557e19cc27a088'],
    commentNumber: '1.8k',
    retweetNumber: '7.5k',
    likeNumber: '45.6k',
  },
...
function Tweets() {
  ...
  const [tweetList,setTweetList]=useState<Props['tweetsType']>(
    dummyData
  );
