            ...
            <div className={styles.RightInside}>
                <form className={styles.SearchLabel} action="">
                    <div className={styles.MagnifierWrapper}>
                        <img className={styles.Magnifier} src={Magnifier} width={"20px"} height={"20px"} alt="no img"/>
                    </div>
                    <input className={styles.SearchInput} placeholder="Search Twitter" type="text"/>
                </form>
                    ...
                    <div className={styles.TrendsInside}>
                        <div className={styles.TrendHeader}>
                            ...
                            <span className={styles.ButtonWrapper}>
                                <a href=""><img src={Setting} width={22} height={22} alt="No img"/></a>
                            </span>
                        </div>
