...
const dummyData = [
  {
    ...
    author: {
      username: '감자튀김',
      user_id: 'FrenchFries',
      profile_img: 'https://img.sbs.co.kr/newsnet/etv/upload/2014/12/11/30000443115_700.jpg'
    },
    retweeting_user: '10',
    reply_to: '100',
    written_at: '2022-07-08T09:21:27.488585Z',
    content: '감.자.튀.김.조.아.감.자.튀.김.조.아.감.자.튀.김.조.아.감.자.튀.김.조.아.감.자.튀.김.조.아.감.자.튀.김.조.아.감.자.튀.김.조.아.감.자.튀.김.조.아.감.자.튀.김.조.아.감.자.튀.김.조.아.감.자.튀.김.조.아.감.자.튀.김.조.아.감.자.튀.김.조.아.감.자.튀.김.조.아.감.자.튀.김.조.아',
    media: [
  ...
  },
  {
    ...
    author: {
      username: '징버거',
      user_id: 'JingBurger',
      profile_img: 'https://w.namu.la/s/ec5be7fbad71fb5dfc41fb21f5eae44f43ab629b0a5f8629d0c57f56a64ea35bdff4fe23ad35ff158fff1e672efc44565ee9ac9195050491411b0a982a8dea985e9bb3d80a1c93e0e99af626eaa3f3e793d111c28106a94cc96dcbd44459a638'
    },
    retweeting_user: '10',
    reply_to: '100',
    written_at: '2022-07-08T09:21:27.488585Z',
    content: '안녕하세요~ 징~버거입니다~ 해냈다~ 해냈어~ 버거가 해냈어~ 징버거! 해냈다~ 해냈어~ 버거가 해냈어~ 징버거!해냈다~ 해냈어~ 버거가 해냈어~ 징버거!',
    media: [
  ...
  },
  {
    ...
    author: {
      username: '이재민',
      user_id: 'JaeminLee',
      profile_img: 'https://cdn.kado.net/news/photo/201911/996781_433270_1949.jpg'
    },
    retweeting_user: '10',
    reply_to: '100',
    written_at: '2022-07-08T09:21:27.488585Z',
...
*/
  ...
  return (
    <div className={styles.HomePageWrapper}>
      ...
      <div className={styles.HomeTweetInputWrapper}>
