...
const LoginPage = () => {
    ...
    return (
        <div className={styles.LoginPageWrapper}>
            <LoginModal setLoginIsOpen={setLoginIsOpen} isOpen={loginModalOpen}></LoginModal>
            <SignUpModal setSignUpIsOpen={setSignUpModalOpen} isOpen={signUpModalOpen}></SignUpModal>
            ...
            <div className={styles.Right}>
                ...
                <div className={styles.SignUpWrapper}>
                    ...
                    <button onClick={()=>{setSignUpModalOpen(true)}} className={styles.Button}>휴대폰 번호나 이메일 주소로 가입하기</button>
