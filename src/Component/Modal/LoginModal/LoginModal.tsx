        ...
        <Modal style={{
            ...
            <div className={styles.ModalWrapper}>
                <header className={styles.ModalHeader}>
                    <div onClick={()=>{props.setLoginIsOpen(false)}} className={styles.XWrapper}><img src={X} width={25} height={25} alt="no img"/></div>
                ...
                <div className={styles.ModalContent}>
                    ...
                    <form className={styles.InputWrapper}>
                        <input className={styles.Input} placeholder="휴대폰 번호, 이메일 주소 또는 사용자 아이디" type="text"/>
